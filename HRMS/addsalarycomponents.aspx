<%@ Page Title="Salary Components" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="addsalarycomponents.aspx.cs" Inherits="HRMS.addsalarycomponents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Salary Compnents Add</b></h4>
									
									<div class="row">

                                                            <div class="col-lg-6">
                        <div class="p-20">
                            <label>Salary Compnents Name</label>
                            
                            <asp:TextBox ID="txtsalarycom" class="form-control" runat="server" placeholder="Enter Name" ></asp:TextBox>

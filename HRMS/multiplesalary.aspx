<%@ Page Title="HRMS| Salary" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"  CodeBehind="multiplesalary.aspx.cs" Inherits="HRMS.multiplesalary" %>
...
<script src="assets/js/jquery.core.js"></script>
    ...
    <div class="row">
							<div class="col-sm-12">
							 	<h1 class="m-t-0 header-title"><b>Pay Slip</b></h1>
									<br />
									<div class="row">
                                        <div class="col-lg-12">
...
<div class="col-lg-6">
                  ...
                  <br />                           
                                              ...
                                              <asp:Button ID="btnsave" OnClick="btnsavess_Click"  runat="server" CssClass="btn btn-warning" Text="Save" />             
                            <asp:Label ID="lblerror" runat="server" Visible="false"></asp:Label>
                                ...
                                <tr>
                                  ...
                                  <th>Total Earning</th>
                                      <th>
                                 <asp:CheckBox id="chklate" runat="server"  AutoPostBack="true" Text="Late Deduction" OnCheckedChanged="chklate_CheckedChanged"/>
                                      ...
                                      <th>
                                                                                                        <asp:CheckBox id="chkabsent" runat="server" AutoPostBack="true" Text="Absent Deduction" OnCheckedChanged="chkabsent_CheckedChanged"/>
               
                                            </th>
                                   <th>
                                                                                                        <asp:CheckBox id="chkloan" runat="server" AutoPostBack="true" Text="Loan" OnCheckedChanged="chkloan_CheckedChanged"/>
                               ...
                               <td> <asp:HiddenField ID="hiddensalary" Value ='<%#Eval("salary")%>' runat="server" /> <label id="lblsalary" runat="server"><%#Eval("salary") %></label></td>
                                             <td>
                                                 ...
                                                 <asp:CheckBox id="BtnLate" CommandName="Late" CommandArgument='<%#Eval("late") %>' runat="server"/>
                                    <label id="lbllate" runat="server"><%#Eval("late") %></label>
                                             ...
                                             <td>
                                                  <asp:CheckBox id="BtnAbsent" CommandName="Absent" CommandArgument='<%#Eval("absent") %>' runat="server"/>
                <label id="lblabsent" runat="server"><%#Eval("absent") %></label>
                                                 
                                  <asp:HiddenField ID="hiddenabsent" Value ='<%#Eval("absent")%>' runat="server" /> 
                                             </td>
                                              <td>
                                                  <asp:CheckBox id="BtnLoan" CommandName="Loan" CommandArgument='<%#Eval("loan") %>' runat="server"/>

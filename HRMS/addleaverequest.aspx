<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="addleaverequest.aspx.cs" Inherits="HRMS.addleaverequest" %>
...
<script src="assets/js/jquery.core.js"></script>
    ...
    <div class="row">
                        ...
                        <div class="form-group">
                         ...
                         <asp:DropDownList ID="ddlempcode" class="form-control" AutoPostBack="true" runat ="server" OnSelectedIndexChanged="ddlempcode_SelectedIndexChanged"></asp:DropDownList>
                              </div>
                                     </div>
                                        </div>
                                    <div class="row">

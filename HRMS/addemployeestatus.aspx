<%@ Page Title="Employee Status Details" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="addemployeestatus.aspx.cs" Inherits="HRMS.addemployeestatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Employee Status Add</b></h4>
                        ...
                        <div class="p-20">
                            ...
                            <asp:TextBox ID="txtempstatus" class="form-control" runat="server" placeholder="Enter Name" ></asp:TextBox>
                            <br />
